...
const NAV = [
  {
    ...
    items: [
      ...
      {
        href: '/jobs/compare', label: 'Compare', icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            <path d="M9 3H5a2 2 0 00-2 2v14a2 2 0 002 2h4M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4M12 8v8M9 12h6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        )
      },
      {
